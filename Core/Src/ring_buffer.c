...
void ring_buffer_init(ring_buffer_t *buffer, data_buffer_t *buf, ring_buffer_size_t buf_size) {
...
extern inline u8 ring_buffer_is_empty(ring_buffer_t *buffer);
extern inline u8 ring_buffer_is_full(ring_buffer_t *buffer);
